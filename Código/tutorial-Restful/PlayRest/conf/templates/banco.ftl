...
<p >   Si quiere volver a ver <b>todos los bancos de trabajo</b> pinche <a href="/laboratorios/${banco.labID}/bancos">aquí </a></p> <br>
  <p >   Si quiere ver <b>todos los recursos</b> de este banco de trabajo pinche <a href="/laboratorios/${banco.labID}/bancos/${banco.id}/recursos">aquí </a></p><br>
    <p >------------------------------------------------- </p><br><br>
    ...
    <div> <b> La lista de recursos del banco de trabajo es: </b><br> <br>
        <#list listaRecursos as recurso>
           <p >El id del recurso del banco es ${recurso.id} </p> <br>
             <p> La URI del recurso del banco es <a href="${recurso.url}">${recurso.url} </a></p> <br>
             ...
             <p >El ID del laboratorio del recurso del banco es <a href="/laboratorios/${recurso.labID}">${recurso.labID} </a> </p> <br>
             <p >El ID del banco del recurso es <a href="${recurso.bancoID}">   ${recurso.bancoID} </a></p> <br>
             <p >------------------------------------------------- </p> <br>
