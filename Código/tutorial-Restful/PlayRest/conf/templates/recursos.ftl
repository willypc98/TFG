...
<p > Si quiere volver a ver <b>todos los laboratorios</b> pinche <a href="/laboratorios">aquí </a></p>
<p >------------------------------------------------- </p> <br>
...
<#list recursos as recurso>
  ...
  <p id="url">La URI del recurso es <a href="${recurso.url}">${recurso.url} </a></p> <br>
